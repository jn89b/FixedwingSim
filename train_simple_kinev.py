...
for j, h in enumerate(histories):
    ...
    for i, pursuer in enumerate(pursuers):
        ax.scatter(pursuer.data_handler.x[0], pursuer.data_handler.y[0],
                   pursuer.data_handler.z[0], label=f'pursuer start {i}')
        ax.plot(pursuer.data_handler.x, pursuer.data_handler.y,
                pursuer.data_handler.z, label=f'pursuer {i}')
    # set title
