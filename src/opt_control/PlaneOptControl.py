from src.opt_control.OptimalControl import OptimalControlProblem
from src.opt_control.Effector import Effector
import casadi as ca
import numpy as np
import time
...
class PlaneOptControl(OptimalControlProblem):
    ...
    def compute_directional_pew_cost(self) -> ca.SX:
        ...
        for i in range(self.N):
            ...
            error_theta_factor = ca.exp(-k_elev *
                                        error_theta/self.Effector.effector_angle)

            e_total = (error_dist_factor + error_psi_factor +
                       error_theta_factor) / 3
    ...
    def omni_cost_function(self) -> ca.SX:
        ...
        for i in range(self.N):
            ...
            effector_dmg = (ratio_distance + directional_cost *
