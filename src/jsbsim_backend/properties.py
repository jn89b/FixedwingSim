...
heading_rad = BoundedProperty('attitude/heading-true-rad', 'yaw [rad]', -math.pi, math.pi)
...
pdot_radps2 = BoundedProperty('accelerations/pdot-rad_sec2', 'roll acceleration [rad/s^2]', -2 * math.pi, 2 * math.pi)
qdot_radps2 = BoundedProperty('accelerations/qdot-rad_sec2', 'pitch acceleration [rad/s^2]', -2 * math.pi, 2 * math.pi)
rdot_radps2 = BoundedProperty('accelerations/rdot-rad_sec2', 'yaw acceleration [rad/s^2]', -2 * math.pi, 2 * math.pi)
