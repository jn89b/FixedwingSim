...
min_pitch = np.deg2rad(-20)
max_roll = np.deg2rad(45)
min_roll = np.deg2rad(-45)
max_yaw = 180
min_yaw = -180

#these are the constraints for the aircraft
aircraft_constraints = {
    ...
    'max_yaw':   max_yaw,
    'min_yaw':   min_yaw, 
    'max_throttle': 15, #this is bad, actually using airspeed 
    'min_throttle': 30, #this is bad, actually using airspeed
}
